...
">CAM</h6>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="col-lg-5 connectedSortable">
		<form action="" id="addResult" method="post">
 			<table style="width: 100%;">
						<tr>
							<th>Event Name</th>
							<td><select id="selectEvent" name="selectEvent" class="form-control" required>
							<!--<option>One</option>-->
						...
						<tr>
							<th></th>
							<td><input type="submit" id="submit" value="Submit" class="btn btn-success" style="float: right;"/></td>
						</tr>
					</table>
				</form>
        </section>
