...
">CAM</h6>-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" treeview">
          <a href="request.html" class="selected" >
  ...
  <div class="content-wrapper">
    ...
    <section class="col-lg-5 connectedSortable">
		<form action="" id="DeleteBook" method="post">
 			<table style="width: 100%;">
						
						<tr>
							<th>Book number</th>
							<td><select id="deleteBook" name="deleteBook" class="form-control" required>
							<!--<option>One</option>-->
						...
						<tr>
							<th>Book name</th>
							<td><input id="bookname" type="text" class="form-control" onkeypress="return isCharKey(event)" required></td>
						</tr>
						<tr>
							<th>Author name</th>
							<td><input id="authorname" type="text" class="form-control" onkeypress="return isCharKey(event)" required></td>
						</tr>
						<tr>
							<th>Related subject</th>
							<td><input id="subject" type="text" class="form-control" onkeypress="return isCharKey(event)" required></td>
						</tr>
						<tr>
							<th></th>
							<td><input type="submit" id="submit" value="Delete" class="btn btn-danger" style="float: right;"/></td>
						</tr>
					</table>
				</form>
        </section>
