    ...
    <section class="col-lg-5 connectedSortable">
		<form action="" id="deleteEvent" method="post">
 			<table style="width: 100%;">
						<tr>
							<th>Select Event</th>
							<td><select id="DeleteEvent" name="DeleteEvent" class="form-control" required>
							<!--<option>One</option>-->
						...
						<tr>
							<th>Event Type</th>
							<td><input type="radio" id="type" name="type" checked value="Individual" required>
							    <label class="radio_but">Individual</label>
							    <input type="radio" id="type" name="type" value="Group">
							  <label  class="radio_but">Group</label></td>
						</tr>
						<tr>
							<th></th>
