...
<head>
  ...
  <meta charset="utf-8">
	...
	<script type="text/javascript" src="Arts.js" ></script>
<style type="text/css">
...
">CAM</h6>-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" treeview">
          <a href="eventListA.php" class="selected" >
  ...
  <div class="content-wrapper">
    ...
    <section class="col-lg-5 connectedSortable">
		<form action="" id="modifyResult" method="post">
 			<table style="width: 100%;">
						<tr>
							<th>Event Name</th>
							<td><select id="selectEventResult" name="selectEventResult" class="form-control" required>
							<!--<option>One</option>-->
						...
						<tr>
							<th>First Prize</th>
							<td><select id="first" name="first" class="form-control" required>
							<!--<option>One</option>-->
							<option value="">Select Resgister Number</option>
							</select></td>
						</tr>
						<tr>
							<th>Second Prize</th>
							<td><select id="second" name="second" class="form-control" required>
							<!--<option>One</option>-->
							<option value="">Select Resgister Number</option>
							</select></td>
						</tr>
						<tr>
							<th>Third Prize</th>
							<td><select id="third" name="third" class="form-control" required>
							<!--<option>One</option>-->
							<option value="">Select Resgister Number</option>
							</select></td>
						</tr>
						<tr>
							<th></th>
							<td><input type="submit" id="submit" value="Update" class="btn btn-warning" style="float: right;"/></td>
						</tr>
					</table>
				</form>
        </section>
