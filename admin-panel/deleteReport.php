...
">CAM</h6>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="col-lg-5 connectedSortable">
		<form action="" id="DeleteReport" method="post">
 			<table style="width: 100%;">
						<tr>
							<th>Report Name</th>
							<td><select id="deleteReport" name="deleteReport" class="form-control" required>
							<!--<option>One</option>-->
						...
						<tr>
							<th>Abstraction</th>
							<td><textarea id="description" class="form-control" rows="5" cols="20"></textarea></td>
						</tr>
						
						<tr>
							<th>Branch</th>
							<td><select id="branch" name="branch" class="form-control bor wid_cen">
