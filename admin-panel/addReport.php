...
">CAM</h6>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="col-lg-5 connectedSortable">
		<form action="" id="addReport" method="post">
 			<table style="width: 100%;">
						
						<tr>
							<th>Report name</th>
							<td><input id="reportname" type="text" class="form-control" required></td>
						</tr>
						<tr>
							<th>Abstraction</th>
							<td><textarea id="description" class="form-control" rows="5" cols="20"  required></textarea></td>
						</tr>
